<?php
function img_gen($name, $array, $max)
{
    ...
    $MyData->addPoints($array, "Score");
    $MyData->setSerieDescription("Score", "Application A");
    $MyData->setPalette("Score", array("R" => 157, "G" => 196, "B" => 22));

    /* Define the absissa serie */
    $MyData->addPoints(array("Citations", "Analysis", "Thesis", "Topic", "Mechanics"), "Families");
    ...
    $myPicture->setFontProperties(array("FontName" => "../pChart/fonts/verdana.ttf", "FontSize" => 11, "R" => 80, "G" => 80, "B" => 80));
    ...
    /* Draw a radar chart */
    $myPicture->setGraphArea(0, 10, 290, 290);
    ...
    $Options["FixedMax"] = $max;
    $SplitChart->drawRadar($myPicture, $MyData, $Options);

    /* Render the picture (choose the best way) */
    //$myPicture->render("../eval_helper/temp_pics/$name.png");
    $myPicture->render("../eval_helper/temp_pics/$name.png");
}
